  ...
  describe('swagger json endpoint', () => {
    ...
    it('strips out any object with x-private', () => {
      ...
      return request
        ...
        .expect(200)
        .then((res) => {
          expect(res.body).to.have.deep.property('paths./public')
          expect(res.body).to.not.have.deep.property('paths./private')
        })
    })
    ...
    it.skip('strips out properies mentioned by x-private', () => {
      ...
      return request
        ...
        .expect(200)
        .then((res) => {
          expect(res.body).to.have.deep.property('paths./public.post')
          expect(res.body).to.not.have.deep.property('paths/public.post.201')
          expect(res.body)
            .to.not.have.deep.property('paths./public.post.x-private')
        })
    })
    ...
    it('can override swagger values', () => {
      ...
      return request
        ...
        .expect(200)
        .then((res) => {
          expect(res.body.basePath).to.be.equal('/foo')
        })
    })
